...
defineOptions({
    layout: (pageProps: { name: string }) => ({
        breadcrumbs: [
            ...
            { title: pageProps.name, href: nginxRoutes.show.url({ name: pageProps.name }) },
        ],
    }),
});
    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <Badge v-if="site" :variant="site.enabled ? 'default' : 'secondary'">
        ...
        <Card v-if="site">
            ...
            <CardContent>
                <form @submit.prevent="submitUpdate" class="space-y-4">
                    ...
                    <Button type="submit" :disabled="updateForm.processing">Save &amp; reload nginx</Button>
                </form>
            </CardContent>
        </Card>
